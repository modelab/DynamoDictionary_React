...
function Home(props){
  return(
    <div className = 'col-md-12' style={{'padding':'100px', 'paddingTop':'15px'}}>
        <h1 className='raleway'>The Dynamo Dictionary</h1>
        <hr/>
        <p className="graytextlg" style={{"color":"lightgray"}}>Welcome to the Dynamo Dictionary, a searchable database for Dynamo functionality. Here you can find explanations for nodes, sample files, and links to more information on associated workflows. This site is constantly evolving as the community continues to add more information. Like the <a href="http://dynamoprimer.com/" target="_blank" style={{'color':'cyan'}}>Dynamo Primer</a>, this dictionary is open-source - check it out on our <a href="https://github.com/DynamoDS/DynamoDictionary" target="_blank"  style={{'color':'cyan'}} >Github page</a> and contribute!</p>
        <hr />
        <br/>
        <h1 className="raleway" style={{"color":"lightgray"}}>Editing this Dictionary</h1>
        <hr/>
        <br/>
        <p className="graytext" style={{"color":"lightgray"}}>Not only is the Dynamo Dictionary open-sourced, you can also edit the repository straight from this webpage! Click on edit icons on node pages and add your own <span style={{"color":"white"}}>in-depth description</span>, update <span style={{"color":"lightgray"}}>examples files and images</span>, or <span style={{"color":"lightgray"}}>add your own!</span>
            <br/> </p><br/>
        ...
        <li className="graytext" style={{'textIndent':'-2em','marginLeft':'2em',"color":"lightgray"}}> Because of the review period, you may have to wait a few days for the Pull request to go through. If you have any <a href="https://github.com/DynamoDS/DynamoDictionary/issues" target="_blank"  style={{'color':'cyan'}}>issues</a>, please dont hesitate to log them <a href="https://github.com/DynamoDS/DynamoDictionary/issues" target="_blank"  style={{'color':'cyan'}}>here.</a></li>
        <br />
        <hr />
        <br/>
