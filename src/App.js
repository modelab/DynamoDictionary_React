...
class App extends Component {
    ...
    render() {
        ...
        <div className = 'container'>
          <div className = 'col-md-3' style={{'height':window.innerHeight-150, 'overflow':'auto', 'borderRight': '1px solid rgb(84, 84, 84)'}}>
            <Sidebar dictionary={this.state.mainObjects} actives = {this.state.actives} handleClick = {this._sideBarClick} iteration={0}/>
          </div>
          <div className = 'col-md-9' style={{'height':window.innerHeight-150, 'overflow':'auto'}}>
            {this.state.actives[0] ? <Branch actives={this.state.actives} handleClick = {this._sideBarClick} /> : <Home/>}
          </div>
